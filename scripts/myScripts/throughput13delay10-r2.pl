...
push @command, qw{ --uplink-queue=red --downlink-queue=red --uplink-queue-args=min_bytes=375000max_bytes=1125000drop_percentage=10 --downlink-queue-args=min_bytes=375000max_bytes=1125000drop_percentage=10 --once --downlink-log=logs/throughput13Delay10_log_r2 -- sh -c};
...
system q{mm-throughput-graph 500 logs/throughput13Delay10_log_r2 > /dev/null};
